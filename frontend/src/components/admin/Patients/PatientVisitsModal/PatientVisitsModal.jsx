        ...
        const loadVisitsWithTurns = () => {
            ...
            getAllTurns(
                ...
                (turnsData) => {
                    ...
                    const patientTurns = safeTurnsData.filter(turn =>
                    ...
                    getAllVisitRecords(
                        ...
                        (visitsData) => {
                            ...
                            const enrichedVisits = safeVisitsData
                                .filter(visit => visit && visit.turnId && patientTurnIds.includes(visit.turnId))
                                .map(visit => {
                                    const relatedTurn = safeTurnsData.find(turn => turn.id === visit.turnId);
                                    return {
                                        ...visit,
